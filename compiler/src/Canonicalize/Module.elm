module Canonicalize.Module exposing (canonicalize)
...
import Canonicalize.Environment.Foreign as Foreign
import Canonicalize.Environment.Local as Local
import Canonicalize.Expression as Expr
