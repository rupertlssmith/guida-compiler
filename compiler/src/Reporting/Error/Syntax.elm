    ...
    case exposing_ of
        ...
        ExposingOperatorReserved op row col ->
            Encode.object
                ...
                , ( "op", Parse.Symbol.badOperatorEncoder op )
                , ( "row", Encode.int row )
                , ( "col", Encode.int col )
                ]
                ...
                case type_ of
                    ...
                    "ExposingOperatorReserved" ->
                        Decode.map3 ExposingOperatorReserved
                            (Decode.field "op" Parse.Symbol.badOperatorDecoder)
                            (Decode.field "row" Decode.int)
                            (Decode.field "col" Decode.int)
    ...
    case expr of
        ...
        OperatorReserved operator row col ->
            Encode.object
                ...
                , ( "operator", Parse.Symbol.badOperatorEncoder operator )
                , ( "row", Encode.int row )
                , ( "col", Encode.int col )
                ]
                ...
                case type_ of
                    ...
                    "OperatorReserved" ->
                        Decode.map3 OperatorReserved
                            (Decode.field "operator" Parse.Symbol.badOperatorDecoder)
                            (Decode.field "row" Decode.int)
                            (Decode.field "col" Decode.int)
